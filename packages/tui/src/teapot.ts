// The Utah teapot as a wireframe, for drawEdges.
// The silhouette is built by revolving a profile and bending two tubes.
// Newell's 32 Bezier patches are more data than a Braille wireframe needs.

import type { P3, Edge } from './vector.js'
